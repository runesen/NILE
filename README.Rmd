...
The goal of `NILE` is to provide an implementation of the statistical estimator proposed by @rune2020.
NILE is an estimator applicable in a nonlinear
instrumental variables (IV) setting and achieves distribution generalization
with linear extensions. For further details refer to the paper @rune2020 [https://arxiv.org/abs/20??.?????].
